...
with data_science_category as (
  select id from skill_categories where slug = 'data-science'
)
insert into skill_details (
  category_id,
  name,
...
with emerging_tech_category as (
  select id from skill_categories where slug = 'emerging-tech'
)
insert into skill_details (
  category_id,
  name,
...
with design_category as (
  select id from skill_categories where slug = 'design'
)
insert into skill_details (
  category_id,
  name,
