...
with data_analysis_category as (
  select id from ff_skills.skill_categories where slug = 'data-analysis'
)
insert into ff_skills.skill_details (
  category_id,
  name,
...
-- 機械学習スキル
with ml_category as (
  select id from ff_skills.skill_categories where slug = 'machine-learning'
)
insert into ff_skills.skill_details (
  category_id,
  name,
...
with ui_design_category as (
  select id from ff_skills.skill_categories where slug = 'ui-design'
)
insert into ff_skills.skill_details (
  category_id,
  name,
