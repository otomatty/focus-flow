...
with agile_category as (
  select id from ff_skills.skill_categories where slug = 'agile-management'
)
...
with risk_category as (
  select id from ff_skills.skill_categories where slug = 'risk-management'
)
insert into ff_skills.skill_details (
  category_id,
  name,
...
with marketing_strategy_category as (
  select id from ff_skills.skill_categories where slug = 'marketing-strategy'
)
insert into ff_skills.skill_details (
  category_id,
  name,
...
with financial_category as (
  select id from ff_skills.skill_categories where slug = 'financial-management'
)
insert into ff_skills.skill_details (
  category_id,
  name,
